// codeunit 50124 BankRecoAutoMatch12
// {
//     trigger OnRun()
//     begin
...
//         UtrnoMatched: Boolean; // Adding UTR No. matched flag
...
//                     // UtrnoMatched := (BankRecMatchCandidates.UTR_No_=); // Check UTR No. match
//                     //   AmountMatched := (BankRecMatchCandidates.Rec_Line_Difference = BankRecMatchCandidates.Remaining_Amoun);
...
//                     //REHAN SAYED
//                     if (BankRecMatchCandidates.UTR_No <> '') Or (BankRecMatchCandidates.UTR_No_SS <> '') then
//                         UtrnoMatched := (BankRecMatchCandidates.UTR_No = BankRecMatchCandidates.UTR_No_SS);
...
//                     ListOfMatchFields := ListOfMatchedFields(AmountMatched, CheckNumMatched, PaymentTypeMatched, MemberShipNumMatched, DocumentNoMatched, ExternalDocumentNoMatched, TransactionDateMatched, RelatedPartyMatched, DescriptionMatched, UtrnoMatched);
...
//     local procedure ListOfMatchedFields(AmountMatched: Boolean; CheckNumMatched: Boolean; PaymentTypeMatched: Boolean; MembershipNumMatched: Boolean; DocumentNoMatched: Boolean; ExternalDocumentNoMatched: Boolean; TransactionDateMatched: Boolean; RelatedPartyMatched: Boolean; DescriptionMatched: Boolean; UTRNmtached: Boolean): Text
//     var
//         BankAccountLedgerEntry: Record "Bank Account Ledger Entry";
//         ListOfFields: Text;
//         Comma: Text;
...
//         if UTRNmtached then begin
//             if ListOfFields <> '' then
//                 ListOfFields += Comma;
//             ListOfFields += BankAccountLedgerEntry.FieldCaption(BankAccountLedgerEntry."UTR No.")
//         end;
