// query 50102 Bank_Reco_Matching
// {
//     QueryType = Normal;
...
//         {
//             DataItemTableFilter = Difference = FILTER(<> 0), "Account Type" = FILTER(= "Bank Account Ledger Entry");
...
//             {
//                 DataItemLink = "Bank Account No." = Bank_Acc_Reconciliation_Line."Bank Account No.", "Cheque No." = Bank_Acc_Reconciliation_Line."Check No.";
